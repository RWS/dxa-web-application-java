...
<div class="icon-list" ${markup.entity(entityModel)}><xpm:entity entity="${entityModel}"/>
    <c:forEach var="link" items="${entityModel.links}" varStatus="status">
        <a href="${link.url}" class="fa-stack fa-lg"
           ...
           ${markup.property(entityModel, "links")}><xpm:property entity="${entityModel}" property="links" index="${status.index}"/>
