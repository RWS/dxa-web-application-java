...
public class TaxonomyServiceFactoryImpl implements TaxonomyServiceFactory {
    ...
    private static final TaxonomyServiceFactory _instance = new TaxonomyServiceFactoryImpl();
     ...
     * @return TaxonomyService representing the TomTom Products taxonomy service
