...
public class DynamicNavigationProvider extends AbstractDynamicNavigationProvider {
    ...
    @Autowired
    public DynamicNavigationProvider(AbstractStaticNavigationProvider staticNavigationProvider, LinkResolver linkResolver, TaxonomyFactory taxonomyFactory, TaxonomyRelationManager relationManager) {
