package com.sdl.webapp.main.filter;

import com.sdl.webapp.common.config.Localization;
import com.sdl.webapp.common.config.LocalizationProvider;
import com.sdl.webapp.common.config.WebAppContext;
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (localization != null) {
            ...
            throw new ServletException("Cannot determine localization for URL: " + url +
                    "\nPlease make sure that you have a publication mapping defined in cd_dynamic_conf.xml which matches this URL.");
        }
