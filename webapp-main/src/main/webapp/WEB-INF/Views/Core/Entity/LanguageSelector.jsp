...
<c:set var="redirectId" value="${pageModel.id}"/>
<c:set var="defaultItem" value="${entity.settings['defaultContentLink'].substring(4)}"/>
    ...
    <div ${markup.entity(entity)}>
        ...
        <select class="selectpicker" data-width="auto">
            <c:forEach var="loc" items="${siteLocalizations}">
                ...
                <c:set var="link" value="${localization.localizePath('/resolve/'.concat(redirectId).concat(params))}"/>
