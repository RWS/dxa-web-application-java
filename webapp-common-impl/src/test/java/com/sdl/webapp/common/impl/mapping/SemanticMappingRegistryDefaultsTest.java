...
public class SemanticMappingRegistryDefaultsTest {
    ...
    @SemanticEntity(entityName = "TE2", vocabulary = SemanticVocabulary.SDL_CORE, prefix = "x")
    ...
    @SemanticEntity(entityName = "TE3", vocabulary = SemanticVocabulary.SCHEMA_ORG)
    ...
    public void testRegisterDefaults() throws NoSuchFieldException {
        ...
        assertThat(field1.get(0), is(new FieldSemantics(SemanticVocabulary.SDL_CORE_VOCABULARY,
                TestEntity1.class.getSimpleName(), "field1")));
        ...
        assertThat(field2.get(0), is(new FieldSemantics(SemanticVocabulary.SDL_CORE_VOCABULARY,
                TestEntity1.class.getSimpleName(), "field2")));
    }
    ...
    public void testRegisterDefaultsWhenAnnotationsPresent() throws NoSuchFieldException {
        ...
        assertThat("The specified semantics must be first in the list", field1.get(0),
                is(new FieldSemantics(SemanticVocabulary.SDL_CORE_VOCABULARY, "TE2", "F1")));
        assertThat("The default semantics must be second in the list", field1.get(1),
                is(new FieldSemantics(SemanticVocabulary.SDL_CORE_VOCABULARY, TestEntity2.class.getSimpleName(),
                        "field1")));
    ...
    public void testRegisterDefaultPrefix() throws NoSuchFieldException {
        ...
        assertThat(field1.get(0), is(new FieldSemantics(SemanticVocabulary.SCHEMA_ORG_VOCABULARY, "TE3", "F1")));
    }
}
