...
public class DefaultLinkResolverFilter extends BaseFilter implements LinkResolverFilter {
    ...
    private static final boolean useXslt = true;
    private final XSLTransformer xslTransformer = XSLTransformer.getInstance();
    private final Pattern xsltPattern;
    ...
    public DefaultLinkResolverFilter() {
        ...
        regExpPattern = Pattern.compile("href=\"" + TridionUtils.TCM_REGEX + "\"");
    ...
    protected void resolveComponent(GenericComponent component, GenericPage page) throws TransformerException {
        if (component != null) {
