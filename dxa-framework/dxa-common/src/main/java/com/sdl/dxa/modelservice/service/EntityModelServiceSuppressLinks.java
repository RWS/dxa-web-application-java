...
public interface EntityModelServiceSuppressLinks extends EntityModelService {
    /**
     * Loads an Entity model.
     *
     * @param entityRequest entity request data
     * @param resolveLinks should be links resolved
     ...
     */
    @NotNull
    EntityModelData loadEntity(EntityRequestDto entityRequest, boolean resolveLinks) throws ContentProviderException;
}
