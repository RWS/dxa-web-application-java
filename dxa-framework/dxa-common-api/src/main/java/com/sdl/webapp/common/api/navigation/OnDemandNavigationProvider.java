...
public interface OnDemandNavigationProvider {
     ...
     * @return list of {@link SitemapItem} representing the requested subtree, never returns <code>null</code>
     */
    @Contract("_, _, _ -> !null")
    List<SitemapItem> getNavigationSubtree(@Nullable String sitemapItemId, @NonNull NavigationFilter navigationFilter, @NonNull Localization localization);
}
