...
<div id="cookie" class="container-fluid page-border" ${markup.entity(entity)}>
    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <p ${markup.property(entity, "text")}><xpm:property entity="${entity}" property="text"/>${entity.text}</p>
        </div>
        <div class="col-sm-3">
            <ul class="nav nav-cookie">
                <li ${markup.property(entity, "continue_")}><xpm:property entity="${entity}" property="continue_"/>
                ...
                <c:if test="${not empty entity.link.url and not empty entity.link.linkText}">
                    <li ${markup.property(entity.link, "linkText")}><xpm:property entity="${entity.link}" property="linkText"/>
