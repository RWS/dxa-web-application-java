package com.sdl.tridion.referenceimpl.servlet;
...
public class ImageFilter implements Filter {
    ...
    // NOTE: hard-coded publication id
    ...
    public void doFilter(ServletRequest req, ServletResponse res,
        ...
        try {
            ...
            if (!url.endsWith(".html")) {
                ...
                BinaryVariantDAO metaDao = (BinaryVariantDAO) StorageManagerFactory.getDAO(PUBLICATION_ID, StorageTypeMapping.BINARY_VARIANT);
                ...
                ItemDAO itemDao = (ItemDAO) StorageManagerFactory.getDAO(PUBLICATION_ID, StorageTypeMapping.ITEM_META);
                ...
                if (refresh) {
                    BinaryContentDAO dao = (BinaryContentDAO) StorageManagerFactory.getDAO(
                            PUBLICATION_ID, StorageTypeMapping.BINARY_CONTENT);
