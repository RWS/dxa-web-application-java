...
<div class="icon-list ${entity.htmlClasses}" ${markup.entity(entity)}>
    <c:forEach var="link" items="${entity.links}" varStatus="status">
        <a href="${link.url}" class="fa-stack fa-lg" title="<dxa:resource key="core.visitUsSocialLinkTitle" arg1="${link.tag.displayText}"/>" ${markup.property(entity, "links", status.index)}>
