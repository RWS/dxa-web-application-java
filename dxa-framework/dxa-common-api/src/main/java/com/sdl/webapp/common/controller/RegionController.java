...
public class RegionController extends BaseController {
     ...
     */
    @RequestMapping(value = {"Region" + "/{regionName}", "Region" + "/{regionName}/"} )
    public String handleGetRegion(HttpServletRequest request, @PathVariable("regionName") String regionName) throws Exception {
